...
public class Karlson extends Character implements Runnable, Soundable {
    ...
    public Karlson(String name, int speed, Position position, Direction direction, Room currentRoom) {
    ...
    public void accelerate() {
        ...
        try {
            ...
            System.out.println("Ошибка: " + getName() + " не может ускориться! " + e.getMessage());
        }
    }
